...
using Xunit;
using QuickGraph.Tests.Factories;
...
namespace QuickGraph.Tests.Algorithms
{
    public class MaximumBipartiteMatchingAlgorithmTest
    {
        ...
        private static void AssertThatMaxMatchEdgesAreValid<TVertex, TEdge>(
            IEnumerable<TVertex> vertexSetA, IEnumerable<TVertex> vertexSetB, MaximumBipartiteMatchingAlgorithm<TVertex, TEdge> maxMatch) where TEdge : IEdge<TVertex>
        {
